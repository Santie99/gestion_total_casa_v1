...
const items = ['Ingresos del mes', 'Gastos del mes', 'Flujo neto', 'Ahorro estimado', 'Alertas', 'Últimos movimientos'];
  ...
  return (
    <div className="space-y-6">
      <div>
        ...
        <p className="mt-2 text-muted-foreground">Resumen general del hogar</p>
      </div>
