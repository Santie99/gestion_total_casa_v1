...
const items = ['Categorías', 'Subcategorías', 'Fecha real', 'Corte mensual', 'Gasto real vs presupuesto'];
  ...
  return (
    <div className="space-y-6">
      <div>
        ...
        <p className="mt-2 text-muted-foreground">Registro centralizado de salidas del hogar</p>
      </div>
