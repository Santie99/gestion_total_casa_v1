...
const items = ['Gasolina', 'SOAT / seguro', 'Tecnomecánica', 'Arreglos', 'Limpieza', 'Impuestos'];
  ...
  return (
    <div className="space-y-6">
      <div>
        ...
        <p className="mt-2 text-muted-foreground">Gastos, mantenimientos y vencimientos del vehículo</p>
      </div>
